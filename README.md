...
The specific script option for the pipeline is managed by adding the variables to the text file in dictionary format. The script will read the dictionary using the JSON package and use it to control the pipeline. All available variables are listed inside of the text file.
